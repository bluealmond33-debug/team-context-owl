...
2. 클론한 폴더를 Claude Code·Codex 같은 AI 도구로 엽니다. `AGENTS.md`의 시작 게이트가 **킥오프 인터뷰**(`_system/KICKOFF_INTERVIEW.md`)를 시작해 팀 구성·연락처·특기·팀 규범·목표를 묻고, 공식 문서를 대신 채웁니다.
3. AI 없이 쓴다면 `000 HOME.md`, `_system/TEAM.md`, `_system/CURRENT_STATE.md`의 대괄호 내용을 직접 채웁니다.
